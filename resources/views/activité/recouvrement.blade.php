...
<section class="laws-section">
    ...
    <div class="container main-content-law">
        <h1 class="title-law">RECOUVEMENTS MARITIMES</h1>

        <div class="security-wrapper">
            <div class="security-visual reveal-left">
                <div class="image-frame">
                    <img src="{{ asset('assets/images/image88.jpeg') }}" alt="Sûreté Portuaire" id="parallax-img-surete">
                </div>
            ...
            <div class="security-info reveal-right">
                <div class="info-header">
                    <span class="law-ref">FACTURATION & VERIFICATION</span>
                    <h2>Strategie</h2>
                </div>
                
                <div class="info-body">
                    <p class="main-text">
                       La décision num:025/MAM du 30 juillet 2020 portant création,
                       attributions et organisation de la Cellule de Réforme du Systême 
                       de Facturation et de Vérification des Recettes à la Direction Générale
                       des Affaires Maritimes et Portuaires stipule en son article 2 que la Cellule
                       de Réforme du Systême de Facturation et de Vérification des Recettes est chargée de :
                    </p>
                    
                    <div id="extraSurete" class="article-extra">
                        <div class="article-highlight">
                            <p>
                              - faire le diagnostic du systême actuel de facturation et de vérification des recettes des Affaires Maritimes,

- mettre en place une stratégie en vue d'optimiser les recettes des Affaires Maritimes,

- élaborer un plan d'équipement du service qui aura la charge de la facturation et de vérification des recettes des Affaires Maritimes

- proposer un budget de fonctionnement et d'équipement de la cellule.

la cellule de Réforme du Système  de facturation et de vérification des Recettes comprend quatre (4) Services Centraux et deux (2) postes de Services Extérieurs.

Les Services Centraux sont:

- Service du Droit de Trafic et des Déclarations;

-Service de la Facturation et du Suivi des Comptes;

-Service des Recettes Diverses;

- Service des Systèmes d'Information et de Communication

 Les Services Extérieurs sont:

- Le Poste de Recettes d'Abidjan;

- Le postes de Recettes de San-Pedro.
                            </p>
                        </div>
                    </div>
                </div>
...
/* S'applique aussi quand le bouton est "actif" (texte = Réduire les détails) */
a.btn-action.active,
