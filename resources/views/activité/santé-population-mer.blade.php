...
<section class="laws-section">
    ...
    <div class="container main-content-law">
        <h1 class="title-law">SANTE DES POPULATION EN MER</h1>

        <div class="security-wrapper">
            <div class="security-visual reveal-left">
                <div class="image-frame">
                    <img src="{{ asset('assets/images/image84.jpeg') }}" alt="Sécurité Maritime" id="parallax-img">
                </div>
            ...
            <div class="security-info reveal-right">
                <div class="info-header">
                    <span class="law-ref">ARRETE N° 0001/MDIE-ET/CAB DU 8 JANVIER 1997</span>
                    <h2> Creation de l'Organisation et le Fonctionnement du Centre Médical </h2>
                </div>
                
                <div class="info-body">
                    <p class="main-text">
                        La santé de la population en se définit par l'ensemble des moyens matériels garantissant la securité des personnes par les decret et articles suivants : 
                    </p>
                    ...
                    <div class="article-highlight">
                        ...
                        <div class="article-content">
                            ...
                            <div id="extraContent" class="article-extra">
                                <p>
                                  Vu : le Décret N° 96-244 du 13 mars 1996 portant Organisation du Ministère délégué auprès du Ministre des Infrastructures Economiques, chargé de l’Energie et des Transports. <br>
                                  VU : l’Arrêté N° 150/METT/CÀB/DAMP du 09 Novembre 1994, portant Attributions et Organisation de la Direction des Affaires Maritimes et portuaires.<br>
                                  ARTICLE 1 il est créé à Abidjan un Centre Médical des Gens de Mer, situé en Zone Portuaire à Vridi.<br>
                                  ARTICLE 2 : Le Centre Médical des Gens de Mer d'Abidjan est placé sous la tutelle du Ministère délégué auprès du• Ministre des. Infrastructures Economiques, chargé de 'Energie et des Transports.<br>
                            </div>
                        </div>
