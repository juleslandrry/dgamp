        ...
        <div class="security-wrapper">
            <div class="security-visual reveal-left">
                <div class="image-frame">
                    <img src="{{ asset('assets/images/image86.jpeg') }}" alt="Sûreté Portuaire" id="parallax-img-surete">
                </div>
            ...
            <div class="security-info reveal-right">
                <div class="info-header">
                    <span class="law-ref">TOURISME EN MER </span>
                    <h2>Divertissement & et loisir </h2>
                </div>
