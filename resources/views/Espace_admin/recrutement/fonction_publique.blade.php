...
<div class="mdg-wrap">
    ...
    <form method="POST" action="{{ route('fonction-publique.update') }}" enctype="multipart/form-data">
                ...
                <div class="card-block">
                    ...
                    <div class="mdg-row2">
                        <div class="mdg-field">
                            ...
                            <input type="text" name="reference[]" value="{{ $doc['reference'] }}" placeholder="Ex: Concours de la Fonction Publique 2026">
                        </div>
                        <div class="mdg-field">
                            <div class="mdg-label">
                            ...
                            <input type="text" name="mots_cles[]" value="{{ $doc['mots_cles'] }}" placeholder="Ex: concours fonction publique 2026">
                        </div>
                    </div>
                    ...
                    <div class="mdg-field">
                        ...
                        <input type="text" name="intitule[]" value="{{ $doc['intitule'] }}" placeholder="Description du document">
                    </div>
        ...
        <button type="button" class="btn-add-card" onclick="addDocument()">+ Ajouter un document</button>
    ...
    wrap.innerHTML = `
        ...
        <div class="mdg-row2">
            <div class="mdg-field">
                ...
                <input type="text" name="reference[]" placeholder="Ex: Nouveau document">
            </div>
            <div class="mdg-field">
                <div class="mdg-label">
                    <span class="mdg-icon i-orange"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="7" cy="7" r="4.2"/><path d="M10.2 10.2L14 14"/></svg></span>
