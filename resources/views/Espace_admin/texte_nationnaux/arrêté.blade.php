...
<div class="mdg-wrap">
    ...
    <h1 class="mdg-title">Arrêtés de Décision</h1>
    <p class="mdg-sub">Modifie un arrêté existant, ajoute-en un nouveau, ou change son fichier PDF.</p>
...
<script>
function addArrete() {
    const list = document.getElementById('arretes-list');
