...
<div class="mdg-wrap">
    ...
    <h1 class="mdg-title">Lois et Règlements</h1>
    <p class="mdg-sub">Modifie une loi existante, ajoute-en une nouvelle, ou change son fichier PDF.</p>
...
<script>
function addLoi() {
    const list = document.getElementById('lois-list');
