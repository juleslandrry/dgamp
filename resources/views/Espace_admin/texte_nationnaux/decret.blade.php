...
<div class="mdg-wrap">
    ...
    <h1 class="mdg-title">Décrets & Arrêtés</h1>
    <p class="mdg-sub">Modifie un document existant, ajoute-en un nouveau, ou change son fichier PDF.</p>
    ...
    <form method="POST" action="{{ route('decrets.update') }}" enctype="multipart/form-data">
                ...
                <div class="card-block">
                    ...
                    <div class="mdg-row2">
                        <div class="mdg-field">
                            ...
                            <input type="text" name="titre[]" value="{{ $doc['titre'] }}" placeholder="Ex: Décret n°2021-804">
                        </div>
                        <div class="mdg-field">
                            <div class="mdg-label">
                            ...
                            <input type="text" name="mots_cles[]" value="{{ $doc['mots_cles'] }}" placeholder="Ex: decret 2021 organisation">
                        </div>
                    </div>
                    ...
                    <div class="mdg-field">
                        ...
                        <input type="text" name="description[]" value="{{ $doc['description'] }}" placeholder="Ex: Portant organisation du SEMTAM">
                    </div>
        ...
        <button type="button" class="btn-add-card" onclick="addDecret()">+ Ajouter un document</button>
    ...
    wrap.innerHTML = `
        ...
        <div class="mdg-row2">
            <div class="mdg-field">
                ...
                <input type="text" name="titre[]" placeholder="Ex: Décret n°2021-804">
            </div>
            <div class="mdg-field">
                <div class="mdg-label">
                    <span class="mdg-icon i-orange"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="7" cy="7" r="4.2"/><path d="M10.2 10.2L14 14"/></svg></span>
                ...
                <input type="text" name="mots_cles[]" placeholder="Ex: decret 2021 organisation">
            </div>
        </div>
        ...
        <div class="mdg-field">
            ...
            <input type="text" name="description[]" placeholder="Ex: Portant organisation du SEMTAM">
        </div>
        ...
        <div class="mdg-field">
            ...
            <div class="mdg-hint">Un fichier PDF est requis pour un nouveau document</div>
        </div>
    `;
