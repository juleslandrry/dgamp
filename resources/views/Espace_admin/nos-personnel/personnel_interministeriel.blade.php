...
<div class="pp-wrap">
    ...
    <h1 class="pp-title">Personnel Interministériel</h1>
    ...
    <form method="POST" action="{{ route('admin.personnel-interministeriel.update') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="section-body">
                <div class="pp-row2">
                    <div class="pp-field">
                        ...
                        <input type="text" name="badge" value="{{ old('badge', $data->badge ?? '') }}" placeholder="Ex: Administration Centrale">
                    </div>
                    <div class="pp-field">
                        <label class="pp-label">Titre principal</label>
                        <input type="text" name="titre" value="{{ old('titre', $data->titre ?? '') }}" placeholder="Ex: Personnel Interministériel">
                    </div>
                </div>
                <div class="pp-field">
        ...
        <div class="section-block">
            ...
            <div class="section-body">
                <div class="pp-field">
                    ...
                    <input type="text" name="section_titre" value="{{ old('section_titre', $data->section_titre ?? '') }}" placeholder="Ex: Le Personnel Interministériel">
                </div>
                <div class="pp-field">
