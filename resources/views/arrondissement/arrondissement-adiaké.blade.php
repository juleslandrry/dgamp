...
<section class="adiake-section">
    ...
    <div class="adiake-container">
        ...
        <div class="adiake-header-main">
            ...
            <h3 class="adiake-main-title">Arrondissement Maritime d'Adiaké</h3>
        </div>
                ...
                <div class="text-scroll-area">
                    <div class="content-visible">
                        <section class="text-part">
                            <h4><i class=""></i> Genèse Historique</h4>
                            <p>Créé en 2002 pour rapprocher l'Administration des acteurs maritimes, l'Arrondissement Maritime d'Adiaké fait partie des services extérieurs essentiels de la DGAMP, au même titre que les six autres arrondissements nationaux.</p>
                        </section>

                        <section class="text-part">
                            <h4><i class=""></i> Étendue Territoriale</h4>
                            <p>Son expertise s'étend sur toute la partie Est du Sud-Comoé, de la frontière ghanéenne à Grand-Bassam. Il gère un réseau unique de trois lagunes : Aby, Tendo et Ehy.</p>
                        </section>
                    </div>

                    <div class="content-hidden" id="extra-content">
                        <section class="text-part">
                            <h4><i class=""></i> Missions & Sûreté</h4>
                            <p>L'arrondissement assure la surveillance des eaux, la lutte contre la piraterie, la sauvegarde de la vie humaine et la coordination des secours (SAR). Il veille également à la sécurité du transport lagunaire et à la protection de l'environnement marin.</p>
                        </section>

                        <section class="text-part">
                            <h4><i class=""></i> Économie & Perspectives</h4>
                            <p>L'activité repose sur la pêche, l'agriculture et un essor touristique majeur lié à ses plans d'eau navigables.</p>
                        </section>
                    </div>
                </div>
