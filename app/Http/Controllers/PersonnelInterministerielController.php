...
use App\Models\PersonnelInterministeriel;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class PersonnelInterministerielController extends Controller
{
    /**
     * Page publique.
     */
    ...
    {
        $data = PersonnelInterministeriel::first();

        return view('personnel.personnel-interministeriel', ['data' => $data]);
    }
    ...
    public function edit()
    {
        ...
        return view('Espace_admin.nos-personnel.personnel_interministeriel', ['data' => $data]);
    }
    ...
    public function update(Request $request)
    {
        ...
        PersonnelInterministeriel::updateOrCreate(['id' => 1], $payload);

        return redirect()
            ->route('admin.personnel-interministeriel')
            ->with('success', 'La page Personnel Interministériel a été mise à jour avec succès.');
    }
}